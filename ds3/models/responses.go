...
type GetCacheEntriesInternalResponse struct {
    CacheInformation CacheInformation
    Headers *http.Header
}

func (getCacheEntriesInternalResponse *GetCacheEntriesInternalResponse) parse(webResponse WebResponse) error {
        return parseResponsePayload(webResponse, &getCacheEntriesInternalResponse.CacheInformation)
}

func NewGetCacheEntriesInternalResponse(webResponse WebResponse) (*GetCacheEntriesInternalResponse, error) {
    defer webResponse.Body().Close()
    expectedStatusCodes := []int { 200 }

    switch code := webResponse.StatusCode(); code {
    case 200:
        var body GetCacheEntriesInternalResponse
        if err := body.parse(webResponse); err != nil {
            return nil, err
        }
        body.Headers = webResponse.Header()
...
type PutGenericDaoNotificationRegistrationInternalResponse struct {
    GenericDaoNotificationRegistration GenericDaoNotificationRegistration
    Headers *http.Header
}

func (putGenericDaoNotificationRegistrationInternalResponse *PutGenericDaoNotificationRegistrationInternalResponse) parse(webResponse WebResponse) error {
        return parseResponsePayload(webResponse, &putGenericDaoNotificationRegistrationInternalResponse.GenericDaoNotificationRegistration)
}

func NewPutGenericDaoNotificationRegistrationInternalResponse(webResponse WebResponse) (*PutGenericDaoNotificationRegistrationInternalResponse, error) {
    defer webResponse.Body().Close()
    expectedStatusCodes := []int { 201 }

    switch code := webResponse.StatusCode(); code {
    case 201:
        var body PutGenericDaoNotificationRegistrationInternalResponse
        if err := body.parse(webResponse); err != nil {
            return nil, err
        }
        body.Headers = webResponse.Header()
...
type DeleteGenericDaoNotificationRegistrationInternalResponse struct {
...
func NewDeleteGenericDaoNotificationRegistrationInternalResponse(webResponse WebResponse) (*DeleteGenericDaoNotificationRegistrationInternalResponse, error) {
    defer webResponse.Body().Close()
    expectedStatusCodes := []int { 204 }

    switch code := webResponse.StatusCode(); code {
    case 204:
        return &DeleteGenericDaoNotificationRegistrationInternalResponse{Headers: webResponse.Header()}, nil
    default:
        return nil, buildBadStatusCodeError(webResponse, expectedStatusCodes)
    }
}

type GetGenericDaoNotificationRegistrationInternalResponse struct {
    GenericDaoNotificationRegistration GenericDaoNotificationRegistration
    Headers *http.Header
}

func (getGenericDaoNotificationRegistrationInternalResponse *GetGenericDaoNotificationRegistrationInternalResponse) parse(webResponse WebResponse) error {
        return parseResponsePayload(webResponse, &getGenericDaoNotificationRegistrationInternalResponse.GenericDaoNotificationRegistration)
}

func NewGetGenericDaoNotificationRegistrationInternalResponse(webResponse WebResponse) (*GetGenericDaoNotificationRegistrationInternalResponse, error) {
    defer webResponse.Body().Close()
    expectedStatusCodes := []int { 200 }

    switch code := webResponse.StatusCode(); code {
    case 200:
        var body GetGenericDaoNotificationRegistrationInternalResponse
        if err := body.parse(webResponse); err != nil {
            return nil, err
        }
        body.Headers = webResponse.Header()
...
type GetGenericDaoNotificationRegistrationsInternalResponse struct {
    GenericDaoNotificationRegistrationList GenericDaoNotificationRegistrationList
    Headers *http.Header
}

func (getGenericDaoNotificationRegistrationsInternalResponse *GetGenericDaoNotificationRegistrationsInternalResponse) parse(webResponse WebResponse) error {
        return parseResponsePayload(webResponse, &getGenericDaoNotificationRegistrationsInternalResponse.GenericDaoNotificationRegistrationList)
}

func NewGetGenericDaoNotificationRegistrationsInternalResponse(webResponse WebResponse) (*GetGenericDaoNotificationRegistrationsInternalResponse, error) {
    defer webResponse.Body().Close()
    expectedStatusCodes := []int { 200 }

    switch code := webResponse.StatusCode(); code {
    case 200:
        var body GetGenericDaoNotificationRegistrationsInternalResponse
        if err := body.parse(webResponse); err != nil {
            return nil, err
        }
        body.Headers = webResponse.Header()
...
type PutFeatureKeyInternalResponse struct {
    FeatureKey FeatureKey
    Headers *http.Header
}

func (putFeatureKeyInternalResponse *PutFeatureKeyInternalResponse) parse(webResponse WebResponse) error {
        return parseResponsePayload(webResponse, &putFeatureKeyInternalResponse.FeatureKey)
}

func NewPutFeatureKeyInternalResponse(webResponse WebResponse) (*PutFeatureKeyInternalResponse, error) {
    defer webResponse.Body().Close()
    expectedStatusCodes := []int { 201 }

    switch code := webResponse.StatusCode(); code {
    case 201:
        var body PutFeatureKeyInternalResponse
        if err := body.parse(webResponse); err != nil {
            return nil, err
        }
        body.Headers = webResponse.Header()
...
type PutHeapDumpInternalResponse struct {
    CreateHeapDumpParams CreateHeapDumpParams
    Headers *http.Header
}

func (putHeapDumpInternalResponse *PutHeapDumpInternalResponse) parse(webResponse WebResponse) error {
        return parseResponsePayload(webResponse, &putHeapDumpInternalResponse.CreateHeapDumpParams)
}

func NewPutHeapDumpInternalResponse(webResponse WebResponse) (*PutHeapDumpInternalResponse, error) {
    defer webResponse.Body().Close()
    expectedStatusCodes := []int { 201 }

    switch code := webResponse.StatusCode(); code {
    case 201:
        var body PutHeapDumpInternalResponse
        if err := body.parse(webResponse); err != nil {
            return nil, err
        }
        body.Headers = webResponse.Header()
...
type DeleteFeatureKeyInternalResponse struct {
...
func NewDeleteFeatureKeyInternalResponse(webResponse WebResponse) (*DeleteFeatureKeyInternalResponse, error) {
    defer webResponse.Body().Close()
    expectedStatusCodes := []int { 204 }

    switch code := webResponse.StatusCode(); code {
    case 204:
        return &DeleteFeatureKeyInternalResponse{Headers: webResponse.Header()}, nil
    default:
        return nil, buildBadStatusCodeError(webResponse, expectedStatusCodes)
    }
}
...
func NewGetBeansRetrieverBeansInternalResponse(webResponse WebResponse) (*GetBeansRetrieverBeansInternalResponse, error) {
    ...
    switch code := webResponse.StatusCode(); code {
    case 200:
        var body GetBeansRetrieverBeansInternalResponse
        if err := body.parse(webResponse); err != nil {
            return nil, err
        }
        body.Headers = webResponse.Header()
...
type GetBeansRetrieversInternalResponse struct {
    DatabaseContents DatabaseContents
    Headers *http.Header
}

func (getBeansRetrieversInternalResponse *GetBeansRetrieversInternalResponse) parse(webResponse WebResponse) error {
        return parseResponsePayload(webResponse, &getBeansRetrieversInternalResponse.DatabaseContents)
}

func NewGetBeansRetrieversInternalResponse(webResponse WebResponse) (*GetBeansRetrieversInternalResponse, error) {
    defer webResponse.Body().Close()
    expectedStatusCodes := []int { 200 }

    switch code := webResponse.StatusCode(); code {
    case 200:
        var body GetBeansRetrieversInternalResponse
        if err := body.parse(webResponse); err != nil {
            return nil, err
        }
        body.Headers = webResponse.Header()
...
type QuiesceDataPathToPrepareForShutdownInternalResponse struct {
...
func NewQuiesceDataPathToPrepareForShutdownInternalResponse(webResponse WebResponse) (*QuiesceDataPathToPrepareForShutdownInternalResponse, error) {
    defer webResponse.Body().Close()
    expectedStatusCodes := []int { 204 }

    switch code := webResponse.StatusCode(); code {
    case 204:
        return &QuiesceDataPathToPrepareForShutdownInternalResponse{Headers: webResponse.Header()}, nil
    default:
        return nil, buildBadStatusCodeError(webResponse, expectedStatusCodes)
    }
}

type PutFakeTapeEnvironmentInternalResponse struct {
    DataPolicy DataPolicy
    Headers *http.Header
}

func (putFakeTapeEnvironmentInternalResponse *PutFakeTapeEnvironmentInternalResponse) parse(webResponse WebResponse) error {
        return parseResponsePayload(webResponse, &putFakeTapeEnvironmentInternalResponse.DataPolicy)
}

func NewPutFakeTapeEnvironmentInternalResponse(webResponse WebResponse) (*PutFakeTapeEnvironmentInternalResponse, error) {
    defer webResponse.Body().Close()
    expectedStatusCodes := []int { 201 }

    switch code := webResponse.StatusCode(); code {
    case 201:
        var body PutFakeTapeEnvironmentInternalResponse
        if err := body.parse(webResponse); err != nil {
            return nil, err
        }
        body.Headers = webResponse.Header()
...
type PutUserInternalResponse struct {
    SpectraUser SpectraUser
    Headers *http.Header
}

func (putUserInternalResponse *PutUserInternalResponse) parse(webResponse WebResponse) error {
        return parseResponsePayload(webResponse, &putUserInternalResponse.SpectraUser)
}

func NewPutUserInternalResponse(webResponse WebResponse) (*PutUserInternalResponse, error) {
    defer webResponse.Body().Close()
    expectedStatusCodes := []int { 201 }

    switch code := webResponse.StatusCode(); code {
    case 201:
        var body PutUserInternalResponse
        if err := body.parse(webResponse); err != nil {
            return nil, err
        }
        body.Headers = webResponse.Header()
...
type DeleteUserInternalResponse struct {
...
func NewDeleteUserInternalResponse(webResponse WebResponse) (*DeleteUserInternalResponse, error) {
    defer webResponse.Body().Close()
    expectedStatusCodes := []int { 204 }

    switch code := webResponse.StatusCode(); code {
    case 204:
        return &DeleteUserInternalResponse{Headers: webResponse.Header()}, nil
    default:
        return nil, buildBadStatusCodeError(webResponse, expectedStatusCodes)
    }
}
